...
public class FocusTimerWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        intent.putExtra("MODE", "FOCUS_NORMAL");
        ...
        settingsIntent.putExtra("MODE", "FOCUS_NORMAL");
        ...
        PendingIntent settingsPendingIntent = PendingIntent.getActivity(context, appWidgetId + 5000, settingsIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    ...
    // Helper to update from Service
    public static void updateWidgetStatus(Context context, boolean isRunning, String statusText) {
        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, FocusTimerWidgetProvider.class));
